...
local cinq_pres
--tcord aa
Menu.Text("Info", "Welcome to tcord.tech! Enjoy your stay! :)")
local main =
{
    aa_sw = Menu.Switch('tcordtech Anti-Aim', 'tcordtech Anti-Aim', "Custom Antiaim", false),
    pres_link = Menu.TextBox('tcordtech Anti-Aim', 'tcordtech Anti-Aim', 'Preset Link', 9999, "https://github.com/kiwihvh/leanyaw/blob/main/presets.json", "Put the link to your preset here (RAW PASTE DATA ONLY!!!!) for example go to https://raw.githubusercontent.com/kiwihvh/leanyaw/main/presets.json"),
    presets = Menu.Combo('tcordtech Anti-Aim', 'tcordtech Anti-Aim', "PRESETS", {"CUSTOM", "TREATYMAIN", "EDGE", "DESYNC ONLY - NO TCORDTECH", "TANK AA"--[[, "FROM WEB LINK"]]}, 0, "Tooltip", function(val)
        if val == 5 then
    ...
    aa_cond = Menu.Combo('tcordtech Anti-Aim', 'tcordtech Anti-Aim', "Conditions", {"Standing", "Moving", "Airborne", "Slowwalk"}, 0)
    --presets = nil --= Menu.Combo('tcordtech Anti-Aim', 'tcordtech Anti-Aim', "PRESETS", {"CUSTOM", "KIWI MAIN", "EDGE", "DESYNC ONLY - NO tcordtech", "TANK AA", "FROM WEB LINK"}, 0)
}
...
local standing ={
     random_desync = Menu.Switch('tcordtech Anti-Aim', 'STANDING', "Random Desync", false),
     fake_l= Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Override Limit Left", 0, 0, 58),
     lby_l = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Override LBY Left", 0, 0, 58),
     fake_r= Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Override Limit Right", 0, 0, 58),
     lby_r = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Override LBY Right", 0, 0, 58),
     yaw_opt = Menu.Combo('tcordtech Anti-Aim', 'STANDING', "Yaw Base", {"Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 4),
     yaw_add = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Yaw Add", 0, -180, 180),
     yaw_mod_opt = Menu.Combo('tcordtech Anti-Aim', 'STANDING', "Yaw Modifier", {"Disabled", "Center", "Offset", "Random", "Spin"}, 0),
     yaw_mod_add = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Modifie Degree", 0, -180, 180),
     fake_opt = Menu.MultiCombo('tcordtech Anti-Aim', 'STANDING', "Fake options", {"Avoit Overlap", "Jitter", "Randomize jitter", "Anti Bruteforce"}, 0),
    --tcordtech
     roll = Menu.Switch('tcordtech Anti-Aim', 'STANDING', "tcordtech Enable", false),
     max_velo_int = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', 'Max Velocity', 100, 0, 600, "Using high values here will break neverlose's movement fix"),
     random_tcordtech = Menu.Switch('tcordtech Anti-Aim', 'STANDING', "Random tcordtech", false),
     rollint_l = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "tcordtech Amount Left", 0, -180, 180),
     rollint_r = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "tcordtech Amount Right", 0, -180, 180),
    --fake pip
     fake_flick = Menu.Switch('tcordtech Anti-Aim',  'STANDING', "Fake Flick", false),
     ticks_to_flick = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Ticks to Flick on", 0, 0, 64),
     fake_flick_angle = Menu.SliderInt('tcordtech Anti-Aim', 'STANDING', "Fake Flick Angle", 0, -180, 180)
...
local moving ={
    random_desync = Menu.Switch('tcordtech Anti-Aim', 'MOVING', "Random Desync ", false),
    fake_l= Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Override Limit Left ", 0, 0, 58),
    lby_l = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Override LBY Left ", 0, 0, 58),
    fake_r= Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Override Limit Right ", 0, 0, 58),
    lby_r = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Override LBY Right ", 0, 0, 58),
    yaw_opt = Menu.Combo('tcordtech Anti-Aim', 'MOVING', "Yaw Base ", {"Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 4),
    yaw_add = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Yaw Add ", 0, -180, 180),
    yaw_mod_opt = Menu.Combo('tcordtech Anti-Aim', 'MOVING', "Yaw Modifier ", {"Disabled", "Center", "Offset", "Random", "Spin"}, 0),
    yaw_mod_add = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Modifie Degree ", 0, -180, 180),
    fake_opt = Menu.MultiCombo('tcordtech Anti-Aim', 'MOVING', "Fake options ", {"Avoit Overlap", "Jitter", "Randomize jitter", "Anti Bruteforce"}, 0),
   --tcordtech
    roll = Menu.Switch('tcordtech Anti-Aim', 'MOVING', "tcordtech Enable ", false),
    max_velo_int = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', 'Max Velocity ', 100, 0, 600, "Using high values here will break neverlose's movement fix"),
    random_tcordtech = Menu.Switch('tcordtech Anti-Aim', 'MOVING', "Random tcordtech ", false),
    rollint_l = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "tcordtech Amount Left ", 0, -180, 180),
    rollint_r = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "tcordtech Amount Right ", 0, -180, 180),
   --fake pip
    fake_flick = Menu.Switch('tcordtech Anti-Aim', 'MOVING', "Fake Flick ", false),
    ticks_to_flick = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Ticks to Flick on ", 0, 0, 64),
    fake_flick_angle = Menu.SliderInt('tcordtech Anti-Aim', 'MOVING', "Fake Flick Angle ", 0, -180, 180)

}


local air ={
    random_desync = Menu.Switch('tcordtech Anti-Aim', 'AIRBORNE', "Random Desync  ", false),
    fake_l= Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Override Limit Left  ", 0, 0, 58),
    lby_l = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Override LBY Left  ", 0, 0, 58),
    fake_r= Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Override Limit Right  ", 0, 0, 58),
    lby_r = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Override LBY Right  ", 0, 0, 58),
    yaw_opt = Menu.Combo('tcordtech Anti-Aim', 'AIRBORNE', "Yaw Base  ", {"Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 4),
    yaw_add = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Yaw Add  ", 0, -180, 180),
    yaw_mod_opt = Menu.Combo('tcordtech Anti-Aim', 'AIRBORNE', "Yaw Modifier  ", {"Disabled", "Center", "Offset", "Random", "Spin"}, 0),
    yaw_mod_add = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Modifie Degree  ", 0, -180, 180),
    fake_opt = Menu.MultiCombo('tcordtech Anti-Aim', 'AIRBORNE', "Fake options  ", {"Avoit Overlap", "Jitter", "Randomize jitter", "Anti Bruteforce"}, 0),
   --tcordtech
    roll = Menu.Switch('tcordtech Anti-Aim', 'AIRBORNE', "tcordtech Enable  ", false),
    max_velo_int = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', 'Max Velocity  ', 100, 0, 600, "Using high values here will break neverlose's movement fix"),
    random_tcordtech = Menu.Switch('tcordtech Anti-Aim', 'AIRBORNE', "Random tcordtech  ", false),
    rollint_l = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "tcordtech Amount Left  ", 0, -180, 180),
    rollint_r = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "tcordtech Amount Right  ", 0, -180, 180),
   --fake pip
    fake_flick = Menu.Switch('tcordtech Anti-Aim', 'AIRBORNE', "Fake Flick  ", false),
    ticks_to_flick = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Ticks to Flick on  ", 0, 0, 64),
    fake_flick_angle = Menu.SliderInt('tcordtech Anti-Aim', 'AIRBORNE', "Fake Flick Angle  ", 0, -180, 180)
...
local slowwalk ={
    random_desync = Menu.Switch('tcordtech Anti-Aim', 'SLOWWALK', "Random Desync   ", false),
    fake_l= Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Override Limit Left   ", 0, 0, 58),
    lby_l = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Override LBY Left   ", 0, 0, 58),
    fake_r= Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Override Limit Right   ", 0, 0, 58),
    lby_r = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Override LBY Right   ", 0, 0, 58),
    yaw_opt = Menu.Combo('tcordtech Anti-Aim', 'SLOWWALK', "Yaw Base   ", {"Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 4),
    yaw_add = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Yaw Add   ", 0, -180, 180),
    yaw_mod_opt = Menu.Combo('tcordtech Anti-Aim', 'SLOWWALK', "Yaw Modifier   ", {"Disabled", "Center", "Offset", "Random", "Spin"}, 0),
    yaw_mod_add = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Modifie Degree   ", 0, -180, 180),
    fake_opt = Menu.MultiCombo('tcordtech Anti-Aim', 'SLOWWALK', "Fake options   ", {"Avoit Overlap", "Jitter", "Randomize jitter", "Anti Bruteforce"}, 0),
   --tcordtech
    roll = Menu.Switch('tcordtech Anti-Aim', 'SLOWWALK', "tcordtech Enable   ", false),
    max_velo_int = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', 'Max Velocity   ', 100, 0, 600, "Using high values here will break neverlose's movement fix"),
    random_tcordtech = Menu.Switch('tcordtech Anti-Aim', 'SLOWWALK', "Random tcordtech   ", false),
    rollint_l = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "tcordtech Amount Left   ", 0, -180, 180),
    rollint_r = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "tcordtech Amount Right   ", 0, -180, 180),
   --fake pip
    fake_flick = Menu.Switch('tcordtech Anti-Aim', 'SLOWWALK', "Fake Flick   ", false),
    ticks_to_flick = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Ticks to Flick on   ", 0, 0, 64),
    fake_flick_angle = Menu.SliderInt('tcordtech Anti-Aim', 'SLOWWALK', "Fake Flick Angle   ", 0, -180, 180)

}
local legit_aa ={
    key = 69,
    enable = Menu.Switch("tcordtech Anti-Aim", "tcordtech Anti-Aim", "Legit AA on use key", false, "Legit AA")--,
    --hotkey = Menu.Hotkey("tcordtech Anti-Aim", "tcordtech Anti-Aim", "Legit AA Bind", 0x45, "LegitAA key(can be e)", function(val) key = val end),
    --should = false
}
local rage={
...
local indicator_wm = Menu.Switch("tcordtech Visuals", "tcordtech Visuals", "Main Indicators", false)
local colorz1 = Menu.ColorEdit("tcordtech Visuals", "tcordtech Visuals", "Primary color", Color.new(1.0, 1.0, 1.0, 1.0))
local colorz2 = Menu.ColorEdit("tcordtech Visuals", "tcordtech Visuals", "Secondary color", Color.new(1.0, 1.0, 1.0, 1.0))
--pasted $$$

--not pasted$$
local custom_hits = Menu.Switch("tcordtech Visuals", "tcordtech Visuals", "Custom Hitsound", false)
local InputText = Menu.TextBox("tcordtech Visuals", "tcordtech Visuals", "Hitsound Path", 200, "buttons\\arena_switch_press_02", "Plays hitsound from the csgo\\sound folder")
local tcordtech_scope = {}

tcordtech_scope.var = Menu.FindVar("Visuals", "View", "Camera", "Remove Scope")
tcordtech_scope.screen = EngineClient:GetScreenSize()
tcordtech_scope.ref = tcordtech_scope.var:GetInt()

tcordtech_scope.menu = {}
tcordtech_scope.menu.switch = Menu.Switch("tcordtech Visuals", "tcordtech Scope", "Enable Custom Scope", false)
tcordtech_scope.menu.offset = Menu.SliderInt("tcordtechn Visuals", "tcordtech Scope", "Offset", 10, 0, 500)
tcordtech_scope.menu.length = Menu.SliderInt("tcordtech Visuals", "tcordtech Scope", "Length", 60, 0, 1000)
tcordtech_scope.menu.anim_speed = Menu.SliderInt("tcordtech Visuals", "tcordtech Scope", "Anim Speed", 15, 1, 30)
tcordtech_scope.menu.col_1 = Menu.ColorEdit("tcordtech Visuals", "tcordtech Scope", "Primary Color", Color.RGBA(255, 255, 255))
tcordtech_scope.menu.col_2 = Menu.ColorEdit("tcordtech Visuals", "tcordtech Scope", "Secondary Color", Color.RGBA(255, 255, 255, 0))

tcordtech_scope.anim_num = 0

tcordtech_scope.lerp = function(a, b, t)
    return a + (b - a) * t
end
...
local url2 = 'https://cdn.discordapp.com/attachments/831092732683485245/973914388119552000/tcord.png'
...
local tag = build_tag('tcord.tech $')
local desync3
tcordtech_scope.on_draw = function()
    if tcordtech_scope.menu.switch:GetBool() then
        tcordtech_scope.var:SetInt(2)

        local_player = EntityList.GetLocalPlayer()
        tcordtech_scope.anim_speed = tcordtech_scope.menu.anim_speed:Get()

        if not local_player or not local_player:IsAlive() or not local_player:GetProp("m_bIsScoped") then 
            tcordtech_scope.anim_num = tcordtech_scope.lerp(tcordtech_scope.anim_num, 0, tcordtech_scope.anim_speed * GlobalVars.frametime)
        else
            tcordtech_scope.anim_num = tcordtech_scope.lerp(tcordtech_scope.anim_num, 1, tcordtech_scope.anim_speed * GlobalVars.frametime)
        end

        tcordtech_scope.offset = tcordtech_scope.menu.offset:Get() * tcordtech_scope.anim_num
        tcordtech_scope.length = tcordtech_scope.menu.length:Get() * tcordtech_scope.anim_num
        tcordtech_scope.col_1 = tcordtech_scope.menu.col_1:Get()
        tcordtech_scope.col_2 = tcordtech_scope.menu.col_2:Get()
        tcordtech_scope.width = 1

        tcordtech_scope.col_1.a = tcordtech_scope.col_1.a * tcordtech_scope.anim_num
        tcordtech_scope.col_2.a = tcordtech_scope.col_2.a * tcordtech_scope.anim_num
        
        tcordtech_scope.start_x = tcordtech_scope.screen.x / 2
        tcordtech_scope.start_y = tcordtech_scope.screen.y / 2

        --Left
        Render.GradientBoxFilled(Vector2.new(tcordtech_scope.start_x - tcordtech_scope.offset, tcordtech_scope.start_y), Vector2.new(tcordtech_scope.start_x - tcordtech_scope.offset - tcordtech_scope.length, tcordtech_scope.start_y + tcordtech_scope.width), tcordtech_scope.col_1, tcordtech_scope.col_2, tcordtech_scope.col_1, tcordtech_scope.col_2)

        --Right
        Render.GradientBoxFilled(Vector2.new(tcordtech_scope.start_x + tcordtech_scope.offset, tcordtech_scope.start_y), Vector2.new(tcordtech_scope.start_x + tcordtech_scope.offset + tcordtech_scope.length, tcordtech_scope.start_y + tcordtech_scope.width), tcordtech_scope.col_1, tcordtech_scope.col_2, tcordtech_scope.col_1, tcordtech_scope.col_2)

        --Up
        Render.GradientBoxFilled(Vector2.new(tcordtech_scope.start_x, tcordtech_scope.start_y + tcordtech_scope.offset), Vector2.new(tcordtech_scope.start_x + tcordtech_scope.width, tcordtech_scope.start_y + tcordtech_scope.offset + tcordtech_scope.length), tcordtech_scope.col_1, tcordtech_scope.col_1, tcordtech_scope.col_2, tcordtech_scope.col_2)

        --Down
        Render.GradientBoxFilled(Vector2.new(tcordtech_scope.start_x, tcordtech_scope.start_y - tcordtech_scope.offset), Vector2.new(tcordtech_scope.start_x + tcordtech_scope.width, tcordtech_scope.start_y - tcordtech_scope.offset - tcordtech_scope.length), tcordtech_scope.col_1, tcordtech_scope.col_1, tcordtech_scope.col_2, tcordtech_scope.col_2)
    end
end
tcordtech_scope.on_destroy = function()
    tcordtech_scope.var:SetInt(tcordtech_scope.ref)
end
function switcher(i)
...
Cheat.RegisterCallback("destroy", tcordtech_scope.on_destroy)
Cheat.RegisterCallback('draw', function()
    tcordtech_scope.on_draw()

    --my watermarker(tcordtech cool shoit)
    ...
    if localplayer then 
        ...
        if localplayer:GetProp("DT_BasePlayer", "m_iHealth") > 0 and wm_enable then
            ...
            local delta, indic_txt = string.format("%.1f", desync2), "tcord.tech"
    ...
    --my watermarker cool tcordtech end
    ...
    --subtabs
        ...
        --standing
            ...
            standing.random_tcordtech:SetVisible(standing.roll:GetBool() and standing_en)
        ...
        --moving
            ...
            moving.random_tcordtech:SetVisible(moving.roll:GetBool() and moving_en)
        ...
        --air
            ...
            air.random_tcordtech:SetVisible(air.roll:GetBool() and air_en)
        ...
        --slowwalk
            ...
            slowwalk.random_tcordtech:SetVisible(slowwalk.roll:GetBool() and slowwalk_en)
        ...
        --custom scopere
        tcordtech_scope.menu.switch:SetVisible(true)
        tcordtech_scope.menu.offset:SetVisible(tcordtech_scope.menu.switch:GetBool())
        tcordtech_scope.menu.length:SetVisible(tcordtech_scope.menu.switch:GetBool())
        tcordtech_scope.menu.anim_speed:SetVisible(tcordtech_scope.menu.switch:GetBool())
        tcordtech_scope.menu.col_1:SetVisible(tcordtech_scope.menu.switch:GetBool())
        tcordtech_scope.menu.col_2:SetVisible(tcordtech_scope.menu.switch:GetBool())
    --clantag
...
local test_now = '{"moving":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":35,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":8},"slowwalk":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":56,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":101,"rollint_l":90,"random_desync":false,"yaw_add":44,"lby_r":58,"fake_opt":0},"air":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":64,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":2},"standing":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":100,"rollint_l":90,"random_desync":false,"yaw_add":23,"lby_r":58,"fake_opt":0}}'
...
local function custom_slowwalk(cmd)
    ...
    if not load_pres1 then
        if not loaded_pres1 then
            load_pres1 = '{"moving":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":35,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":8},"slowwalk":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":56,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":101,"rollint_l":90,"random_desync":false,"yaw_add":44,"lby_r":58,"fake_opt":0},"air":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":64,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":2},"standing":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":100,"rollint_l":90,"random_desync":false,"yaw_add":23,"lby_r":58,"fake_opt":0}}'
    ...
    if not load_pres2 then
        if not loaded_pres2 then
            load_pres2 = '{"moving":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":35,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":8},"slowwalk":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":56,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":101,"rollint_l":90,"random_desync":false,"yaw_add":44,"lby_r":58,"fake_opt":0},"air":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":64,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":2},"standing":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":100,"rollint_l":90,"random_desync":false,"yaw_add":23,"lby_r":58,"fake_opt":0}}'
    ...
    if not load_pres4 then
        if not loaded_pres4 then
            load_pres4 = '{"moving":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":35,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":8},"slowwalk":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":56,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":101,"rollint_l":90,"random_desync":false,"yaw_add":44,"lby_r":58,"fake_opt":0},"air":{"yaw_mod_opt":1,"fake_flick":false,"yaw_opt":4,"roll":false,"rollint_r":0,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":64,"max_velo_int":100,"rollint_l":0,"random_desync":false,"yaw_add":0,"lby_r":58,"fake_opt":2},"standing":{"yaw_mod_opt":0,"fake_flick":false,"yaw_opt":4,"roll":true,"rollint_r":90,"fake_l":58,"random_tcordtech":false,"lby_l":58,"fake_flick_angle":0,"fake_r":58,"ticks_to_flick":0,"yaw_mod_add":0,"max_velo_int":100,"rollint_l":90,"random_desync":false,"yaw_add":23,"lby_r":58,"fake_opt":0}}'
