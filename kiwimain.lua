--script hazos
local exploit_amt = Menu.SliderInt("treatymain$", "treatymain$$$$ value", 0, 0, 32, "idk 17(maxusr +1)")
local exploit_fake_pitch = Menu.SliderInt("treatymain$", "treatymain$$$$ fake pitch", 0, -90, 90, "idk")
local exploit_real_pitch = Menu.SliderInt("treatymain$", "treatymain$$$$ real pitch", 0, -90, 90, "idk")
local exploit_yaw_l = Menu.SliderInt("treatymain$", "treatymain$$$$ fake yaw_l", 0, -180, 180, "115")
local exploit_yaw_r = Menu.SliderInt("treatymain$", "treatymain$$$$ fake yaw_r", 0, -180, 180, "-115")
local exploit_real_yaw_l = Menu.SliderInt("treatymain$", "treatymain$$$$ real yaw_l", 0, -180, 180, "-14 ")
local exploit_real_yaw_r = Menu.SliderInt("treatymain$", "treatymain$$$$ real yaw_r", 0, -180, 180, "58 ")
local exploit = Menu.Switch("treatymain$", "treatymain$$$$", false)
local show_fake = Menu.Switch("treatymain$", "showfake shit idk", false)
local random = Menu.Switch("treatymain$", "RANDOM", false)
